...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cvc_reducer = __webpack_require__(182);

	var _cvc_reducer2 = _interopRequireDefault(_cvc_reducer);

	var _card_number_reducer = __webpack_require__(184);

	var _card_number_reducer2 = _interopRequireDefault(_card_number_reducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	// store is created here!
	var combined = (0, _redux.combineReducers)({
	    cvc: _cvc_reducer2.default,
	    cardNumber: _card_number_reducer2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CvcBox = function CvcBox(_ref) {
	    var value = _ref.value;
	    var changeValue = _ref.changeValue;
	    var error = _ref.error;
	    var markDirty = _ref.markDirty;
	    ...
	    return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('input', { value: value, onChange: onChange, onBlur: markDirty }),
	        renderError()
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        cvcActions: (0, _redux.bindActionCreators)(cvcActions, dispatch),
	        cardNumberActions: (0, _redux.bindActionCreators)(cardNumberActions, dispatch)
	    };
	};

	module.exports = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_form2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cvc_box = __webpack_require__(160);

	var _cvc_box2 = _interopRequireDefault(_cvc_box);

	var _card_number_box = __webpack_require__(183);

	var _card_number_box2 = _interopRequireDefault(_card_number_box);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Form = function Form(_ref) {
	    var cvcProps = _ref.cvcProps;
	    var cvcActions = _ref.cvcActions;
	    var cardNumberProps = _ref.cardNumberProps;
	    var cardNumberActions = _ref.cardNumberActions;

	    console.log(cvcProps, cvcActions, cardNumberProps, cardNumberActions);
	    return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_cvc_box2.default, _extends({}, cvcProps, cvcActions)),
	        _react2.default.createElement(_card_number_box2.default, _extends({}, cardNumberProps, cardNumberActions))
	    );
	};
...
/***/ function(module, exports) {
	...
	var CHANGE_CVC = 'CHANGE_CVC';
	var MARK_CVC_DIRTY = 'MARK_CVC_DIRTY';
	...
	var reducer = function reducer() {
	    ...
	    switch (type) {
	        case CHANGE_CVC:
	            var error = state.dirty ? !isValid(value) : false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardNumberBox = function CardNumberBox(_ref) {
	    var value = _ref.value;
	    var changeValue = _ref.changeValue;
	    var error = _ref.error;
	    var markDirty = _ref.markDirty;
...
/***/ function(module, exports) {
	...
	var CHANGE_CARD_NUMBER = 'CHANGE_CARD_NUMBER';
	var MARK_CARD_NUMBER_DIRTY = 'MARK_CARD_NUMBER_DIRTY';
